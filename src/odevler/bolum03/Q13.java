...
public class Q13 {
    ...
    public static void main(String[] args) {
        ...
        // Vergi hesaplama
        double tax = 0;
        if(filingStatus == 0) { // Single filter
        ...
        } else if (filingStatus == 1){ // Married filing jointly
        ...
        } else if (filingStatus == 2){// Married filing separately
            if (taxableIncome <= 8350){
                tax = taxableIncome * 0.10;
            } else if (taxableIncome <= 33950){
                tax = 8350 * 0.10 + (taxableIncome - 8350) * 0.15;
                ...
                tax = tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (186475 - 104425) * 0.33 + (taxableIncome - 186475) * 0.35;
            }
            ...
            if (taxableIncome <= 11950){
                ...
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (taxableIncome - 117458) * 0.28;
            } else if (taxableIncome <= 372950){
                tax = tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117458) * 0.28 + (taxableIncome - 190200) * 0.33;
            } else {
                tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117458) * 0.28 + (372950 - 190200) * 0.33 + (taxableIncome - 372950) * 0.35;
            }
        } else {
